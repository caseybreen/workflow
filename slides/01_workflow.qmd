...
3.   Upload an R markdown script to GitHub Repository
...
-   Write papers, take notes, put together slides
...
2.  Generate .bibtex file \[or individual cites\]

3.  Move .bibtex file to Latex repository
...
-   Add 3 papers to the new collection

    -   Drop in pdf files or using Zotero connector
